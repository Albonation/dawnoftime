...
custom_colour_table_type custom_colour_table[]={
	...
	{CCWRAP(CC_CHANNEL_CLANTALK_TEXT),		(unsigned char)'\x99', CCF_NOBLE,	"Channel","ClanTalk Text"},
	{CCWRAP(CC_CHANNEL_CLANTALK_PREFIX),	(unsigned char)'\x9a',CCF_NOBLE,	"Channel","ClanTalk Prefix"},
	...
	{CCWRAP(CC_INFO_HEADER),				(unsigned char)'\x8a',0,	"Info","Info Header"},
	{CCWRAP(CC_INFO_TEXT),					(unsigned char)'\x8b',0,	"Info","Info Text"},
	{CCWRAP(CC_MISC_RETURN_TO_CONTINUE),	(unsigned char)'\xaa',0,	"Misc","Return to Continue"},
	{CCWRAP(CC_MISC_EQUIPMENT_LISTS),		(unsigned char)'\xab',0,	"Misc","Equipment Lists"},
	{CCWRAP(CC_MISC_EQUIPMENT_LISTS_NONE),	(unsigned char)'\xc5',0,	"Misc","Equipment Lists - None"},
	...
	{CCWRAP(CC_GAIN_XP),					(unsigned char)'\xa7', 0,"Gain","XP"},
	{CCWRAP(CC_GAIN_RPS),					(unsigned char)'\xa8', 0,"Gain","RPS"},
	{CCWRAP(CC_GAIN_LEVEL),					(unsigned char)'\xa9', 0,"Gain","Level"},
	...
	{CCWRAP(CC_PROMPT_SWITCHEDPREFIX),		(unsigned char)'\x8c', CCF_IMM,"Prompt","Switched Prefix"},
	{CCWRAP(CC_PROMPT_SWITCHEDHOLYSPEECH),	(unsigned char)'\xae', CCF_IMM,"Prompt","Switched HolySpeech"},
	...
	{CCWRAP(CC_SCORE_LEVEL),				(unsigned char)'\xb0',	0,		"Score","Level"},
	{CCWRAP(CC_SCORE_RACE_GENDER_CLASS),	(unsigned char)'\xb1', 0,		"Score","Race/Gender/Class"},
	{CCWRAP(CC_SCORE_LABELS),				(unsigned char)'\xb2', 0,		"Score","Labels"},
	{CCWRAP(CC_SCORE_ATTRIBUTES),			(unsigned char)'\xb3', 0,		"Score","Attributes"},
	{CCWRAP(CC_SCORE_BORN),					(unsigned char)'\xb4', 0,		"Score","Born"},
	{CCWRAP(CC_SCORE_AGE),					(unsigned char)'\xb5', 0,		"Score","Age"},
	{CCWRAP(CC_SCORE_PRAC_TRAIN),			(unsigned char)'\xb6', 0,		"Score","Prac/Train"},
	{CCWRAP(CC_SCORE_XP_RPS),				(unsigned char)'\xb7', 0,		"Score","XP/RPS"},
	{CCWRAP(CC_SCORE_XPTNL),				(unsigned char)'\xb8', 0,		"Score","XPTNL"},
	{CCWRAP(CC_SCORE_CURRENTVALUE),			(unsigned char)'\xb9', 0,		"Score","Current Value"},
	{CCWRAP(CC_SCORE_MAXVALUE),				(unsigned char)'\xba', 0,		"Score","Max Value"},
	{CCWRAP(CC_SCORE_ALIGNMENT),			(unsigned char)'\xbb', 0,		"Score","Alignment"},
	{CCWRAP(CC_SCORE_AC),					(unsigned char)'\xbc', 0,		"Score","AC"},
	{CCWRAP(CC_SCORE_GOLD),					(unsigned char)'\xbd', 0,		"Score","Gold"},
	{CCWRAP(CC_SCORE_SILVER),				(unsigned char)'\xbe', 0,		"Score","Silver"},
	{CCWRAP(CC_SCORE_FORWARD_SLASH),		(unsigned char)'\xbf', 0,		"Score","Forward Slash"},
	{CCWRAP(CC_SCORE_IMMORTAL_VALUES),		(unsigned char)'\xc0', CCF_IMM,"Score","Immortal Values"},
	{CCWRAP(CC_SCORE_SHOW_AFFECTS_TITLE),	(unsigned char)'\xc1', 0,		"Score","Show Affects Title"},
	{CCWRAP(CC_SCORE_SHOW_AFFECTS_TEXT),	(unsigned char)'\xc2', 0,		"Score","Show Affects Text"},


	{CCWRAP(CC_SHOWCOL_CUSTOM),				'f', 0,			"Showcolour","Custom Active"},
	{CCWRAP(CC_SHOWCOL_TEMPLATE),			'F', 0,			"Showcolour","Template Active"}, 

	{CCWRAP(CC_SOCKETS_BRACKET),			(unsigned char)'\x9b', CCF_SOCK,"Sockets","Brackets"},
	{CCWRAP(CC_SOCKETS_NUMBER),				(unsigned char)'\x9c', CCF_SOCK,"Sockets","Descriptor #"},
	{CCWRAP(CC_SOCKETS_STATE_PLAYING),		(unsigned char)'\x9d', CCF_SOCK,"Sockets","State-Playing"},
	{CCWRAP(CC_SOCKETS_STATE_OTHER),		(unsigned char)'\x9e', CCF_SOCK,"Sockets","State-Other"},
	{CCWRAP(CC_SOCKETS_LOGIN_TIME),			(unsigned char)'\x9f', CCF_SOCK,"Sockets","Login Time"},
	{CCWRAP(CC_SOCKETS_IDLE),				(unsigned char)'\xa0', CCF_SOCK,"Sockets","Idle Time"},
	{CCWRAP(CC_SOCKETS_NAME),				(unsigned char)'\xa1', CCF_SOCK,"Sockets","Name"},
	{CCWRAP(CC_SOCKETS_HOST),				(unsigned char)'\xa2', CCF_SOCK,"Sockets","Host"},
	{CCWRAP(CC_SOCKETS_HOSTMULTI),			(unsigned char)'\xaf',CCF_ADMIN,"Sockets","Host-Multi"},
	{CCWRAP(CC_SOCKETS_SYSTIME),			(unsigned char)'\xa3', CCF_SOCK,"Sockets","System Time"},
	{CCWRAP(CC_SOCKETS_BAR),				(unsigned char)'\xa4', CCF_SOCK,"Sockets","Bar"},
	{CCWRAP(CC_SOCKETS_IDENT),				(unsigned char)'\xa5', CCF_SOCK,"Sockets","Ident Response"},
	{CCWRAP(CC_SOCKETS_NONSTANDARDIDENT),	(unsigned char)'\xa6', CCF_SOCK,"Sockets","NonStandard Ident Response"},
	...
	{CCWRAP(CC_OLC_SET_FLAG),				(unsigned char)'\'',0,			"OLC","Set Flag"},
	{CCWRAP(CC_OLC_UNSET_FLAG),				'$', 0,			"OLC","Unset Flag"}, 	
	{CCWRAP(CC_OLC_UNSETTABLE_FLAG),		(unsigned char)'\x98', 0,		"OLC","Unsettable Flag"},
	...
	{CCWRAP(CC_WHO_BRACKET_NORMAL),			(unsigned char)'\x96', 0,			"Wholist","Brackets - Normal"},
	{CCWRAP(CC_WHO_BRACKET_IRC),			(unsigned char)'\x97', 0,			"Wholist","Brackets - IRC"},
	{CCWRAP(CC_WHO_BRACKET_IMMORTAL),		(unsigned char)'\x83', 0,			"Wholist","Brackets - Immortal"},
	{CCWRAP(CC_WHO_STARS_MORTAL),			(unsigned char)'\x81', 0,			"Wholist","Mortal Stars "},
	{CCWRAP(CC_WHO_STARS_IMM),				(unsigned char)'\x82', 0,			"Wholist","Immortal Level"},
	{CCWRAP(CC_WHO_AFK_QUIET),				(unsigned char)'\x84', 0,			"Wholist","AFK & Quiet"},
	{CCWRAP(CC_WHO_LINKDEAD),				(unsigned char)'\x85', 0,			"Wholist","Linkdead"},
	
	{CCWRAP(CC_WHO_ADMIN_NOCHANNELED),		(unsigned char)'\x86', CCF_ADMIN,	"WholistAdmin","No Channeled (!)"},
	{CCWRAP(CC_WHO_ADMIN_LOGGED),			(unsigned char)'\x87', CCF_ADMIN,	"WholistAdmin","Logged (L)"},
	
	{CCWRAP(CC_WHO_IMM_NOT_WIZI),			(unsigned char)'\x88', CCF_IMM,	"WholistImm","[IO]Wizi Off"},
	{CCWRAP(CC_WHO_IMM_IWIZI),				(unsigned char)'\x89', CCF_IMM,	"WholistImm","IWizi On"},
	{CCWRAP(CC_WHO_IMM_OWIZI),				(unsigned char)'\x90', CCF_IMM,	"WholistImm","OWizi On"},
	{CCWRAP(CC_WHO_IMM_WHOINVIS),			(unsigned char)'\x91', CCF_IMM,	"WholistImm","WhoInvis"},

	{CCWRAP(CC_WHO_IMM_IMMTALKHASH),		(unsigned char)'\x92', CCF_IMM,	"WholistImm","Immtalk Hash"},
	{CCWRAP(CC_WHO_IMM_ACTIVE),				(unsigned char)'\x93', CCF_IMM,	"WholistImm","Active"},
	{CCWRAP(CC_WHO_IMM_QBC),				(unsigned char)'\x94', CCF_IMM,	"WholistImm","`=,(`=-Q`=,)`=,(`=-B`=,)`=,(`=-C`=,)"},
	{CCWRAP(CC_WHO_IMM_QBC_BRACKETS),		(unsigned char)'\x95', CCF_IMM,	"WholistImm","`=,(`=-Q`=,)`=,(`=-B`=,)`=,(`=-C`=,) Brackets"},
	...
	{CCWRAP(CC_HELP_BAR),					(unsigned char)'\xad', 0,	"Help","Header/Footer Bar"},
	...
	{CCWRAP(CC_ROOM_LOCKERS),				(unsigned char)'\x8d', 0,	"Room","Lockers"},
	{CCWRAP(CC_ROOM_EXITS),					'a', 0,	"Room","Exits"}, 
	{CCWRAP(CC_ROOM_FULLEXITS),				(unsigned char)'\xac', 0,	"Room","FullExits"},
	...
	{CCWRAP(CC_RP_SAYLINE),					(unsigned char)'\xc3', 0,"RP","Says - Entire line"},
	{CCWRAP(CC_RP_EMOTELINE),				(unsigned char)'\xc4', 0,"RP","Emotes - Entire line"},
